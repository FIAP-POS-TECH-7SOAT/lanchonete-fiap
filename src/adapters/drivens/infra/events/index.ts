...
const prismaOrderRepository = new PrismaOrderRepository(prismaOrderProductRepository)
const generateCodeProvider = new GenerateCodeProvider()
const addCodeToOrderByIdUseCase = new AddCodeToOrderByIdUseCase(prismaOrderRepository,generateCodeProvider)
